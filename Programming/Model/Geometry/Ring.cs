...
namespace Programming.Model.Geometry
{
    ...
    public class Ring
    {
        ...
        /// 
        /// <param name="outerRadius">Внешний радиус.
        /// Значение должно быть положительным числом.
        /// Значение должно быть больше внутреннего радиуса.</param>
        /// 
        /// <param name="innerRadius">Внутренний радиус.
        /// Значение должно быть положительным числом.
        /// Значение должно быть меньше внешнего радиуса.</param>
