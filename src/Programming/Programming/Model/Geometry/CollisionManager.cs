...
namespace Programming.Model.Geometry
{
    ...
    public static class CollisionManager
    {
        ...
        /// <returns>Возвращает значение true,
        /// если выполняются условия пересечения двух треугольников и false, если нет.</returns>
        ...
        /// <returns>Возвращает значение true,
        /// если выполняется условие пересечения двух колец и false, если нет.</returns>
